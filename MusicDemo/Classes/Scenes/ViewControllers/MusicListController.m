...
- (void)viewDidLoad {
    ...
    [[DataHelper shareDataHelper] setResultBlock:^{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.music = [[DataHelper shareDataHelper] getMusicModelFromIndexPath:indexPath];
    return cell;
}

- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    PlayerViewController *playerVC = [PlayerViewController sharePlayerVC];
    //viewController是单例的,它上面的view是懒加载的,不去调用就不去加载
